...
import { View, Form, Input, Button, Radio, Checkbox, Text, Picker, Textarea, Switch } from '@tarojs/components';
    ...
    <View className="form-page">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <View className="form-item">
          ...
          {errors.birthday && <Text className="error-message">{errors.birthday}</Text>}
        </View>
        ...
        <View className="form-item">
          ...
          {errors.agreement && <Text className="error-message">{errors.agreement}</Text>}
        </View>
